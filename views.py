...
def register_json_routes(app):
    ...
    api.route(TillYesterdaysProfitList, "daily_profits_list", "/api/till_yestardays_profit")
    api.route(TillYesterdaysProfitDetail, "daily_profits_detail", "/api/till_yestardays_profit/<int:id>")
